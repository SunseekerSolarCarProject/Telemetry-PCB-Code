...
#ifndef RS232_2_ENABLE
#define RS232_2_ENABLE 0
#endif

// Event timing
//#define SMCLK_RATE		16000000	// Hz
#define SMCLK_RATE		8000000	// Hz
#define ACLK_RATE		32768		// Hz
#define TICK_RATE		16			// Hz
#define DEBOUNCE_TIME	5	
#define HS_COMMS_SPEED		16*1			// Number of ticks per event:  1 sec
...
#define MODEM_UCBRS1 0x0A // 2*ROUND(SMCLK_RATE/MODEM_BR-INT(SMCLK_RATE/MODEM_BR))*8
#endif

#ifndef MODEM_BR2
#define MODEM_BR2 115200
#define MODEM_UCBRS2 0x0E // 2*ROUND(SMCLK_RATE/MODEM_BR-INT(SMCLK_RATE/MODEM_BR))*8
#endif

#ifndef USB_BR
#define USB_BR 9600
#define USB_UCBRS 0x0A // 2*ROUND(SMCLK_RATE/UART_BR-INT(SMCLK_RATE/UART_BR))*8
#endif

#ifndef UART_BR
#define UART_BR 19200
#define UART_UCBRS 0x06 // 2*ROUND(SMCLK_RATE/UART_BR-INT(SMCLK_RATE/UART_BR))*8
#endif
// Ticks
...
extern unsigned volatile char forceread;
...
#define JMP1				0x40
#define JMP2				0x80
#define P1T_UNUSED			0x00

// Port 2
#define JMP3				0x01  // CAN1_CONT_nINT
#define BUTTON				0x02
#define CAN2_VEN			0x04
#define CAN2_VFG			0x08
#define RTCCLK				0x10
#define CAN1_TR_EN			0x20
#define CAN1_TR_RS			0x40
#define CAN1_CONT_nRST		0x80
#define P2T_UNUSED			0x00

// Port 3
#define CAN1_CONT_nCS		0x01
#define CAN1_SIMO			0x02
#define CAN1_SOMI			0x04
#define CAN1_CLK			0x08
#define P34					0x10
#define P35					0x20
#define CAN2_CONT_nCS		0x40
#define CAN2_SIMO			0x80
#define P3T_UNUSED			0x10 | 0x20

// Port 4
#define CAN1_CONT_nINT			0x01
#define CAN1_CONT_nRX0BF		0x02
#define CAN1_CONT_nRX1BF		0x04
#define CAN2_CONT_nINT			0x08
#define CAN2_CONT_nRX0BF		0x10
#define CAN2_CONT_nRX1BF		0x20
#define P46						0x40
#define P47						0x80
#define P4T_UNUSED			0x40 | 0x80
...
#define XT2IN				0x04
#define XT2OUT				0x08
#define CAN2_SOMI			0x10
#define CAN2_CLK			0x20
#define RS1TX				0x40
#define RS1RX				0x80
#define P5T_UNUSED			0x00

// Port 6
#define P60				0x01
#define P61				0x02
#define P62				0x04
#define PWR_5V_EN		0x08
#define P64				0x10
#define P65				0x20
#define VOLT_EN			0x40
#define VOLT_AN			0x80
#define P6T_UNUSED		0x00
...
#define TEMP_AN			0x40
#define P77				0x80
#define P7T_UNUSED		0x01 | 0x02 | 0x04 | 0x08 | 0x10 | 0x20 | 0x80

// Port 8
#define P80				0x01
#define P81				0x02
#define CAN2_CONT_RST	0x04
#define CAN2_TR_EN		0x08
#define CAN2_TR_RS		0x10
#define RS_nEN			0x20
#define RS_SHDN			0x40
#define P87				0x80
#define P8T_UNUSED		0x01 | 0x02 | 0x80
...
#define P96				0x40
#define P97				0x80
#define P9T_UNUSED			0x01 | 0x02 | 0x04 | 0x08 | 0x10 | 0x20 | 0x80
...
#define P106				0x40
#define P107				0x80
#define P10T_UNUSED			0x01 | 0x02 | 0x40 | 0x80
...
static int addr_lookup[LOOKUP_ROWS][5] = {
  //address                           ASCII Offset      MSG_REC position        Packet(0-HF:1-LF:2-Status)		Filter Priority
		  ...
		  {MC_CAN_BASE1 + MC_LIMITS,	     12,                0x1000,                   0,							15},                    //1-0x01        High = Active Motor              Low = Error & Limit flags
		  ...
		  {AC_CAN_BASE + AC_M1,               8,                0x0100,                   0,							26},                    //40-0x01       High = Array Voltage Average	 Low = Array Current Average
		  {AC_CAN_BASE + AC_M2,               9,                0x0200,                   0,							27},                    //41-0x02	    High = Array Voltage Average	 Low = Array Current Average
//		  {AC_CAN_BASE + AC_M3,              10,                0x0400,                   0,							28},                    //42-0x03	    High = Array Voltage Average	 Low = Array Current Average
		  {AC_CAN_BASE + AC_ISH,             10,                0x0400,                   0,							 6},                    //43-0x04	    High = Shunt Current             Low = Battery Voltage
		  {AC_CAN_BASE + AC_TMAX,            11,                0x0800,                   0,						    14},                    //44-0x05	    High = Max. Temperature		     Low = Max. Temperature MPPT
