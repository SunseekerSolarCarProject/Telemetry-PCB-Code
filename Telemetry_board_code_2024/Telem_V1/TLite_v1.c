//***************************************************************************************
//  Telemetry lite board for sunseeker 2024
//  created by Dr. Brad and Drew Thompson
//
//  April 2024
//***************************************************************************************
...
//Extra Information paramters within the code
...
/*
    ...
    delay();
    delay();
    CPUART_puts("Type <enter> to continue\0");
    ch = 0x00;
    while(ch != 0x0D)
    {
        ch = CPUART_getchar();
...
*/
    ...
    while(1)
    {
        ...
        {
        status_flag = FALSE;
        LED_TOG;                      // Toggle P1.0 using exclusive-OR
        LEDR_TOG;
        LEDG_TOG;
