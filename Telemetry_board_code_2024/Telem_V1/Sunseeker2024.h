...
#define STATUS_COUNT    10                      // Number of ticks per event: 0.1 sec
#define CAN_COMMS_COUNT     100                 // Number of ticks per event:  1 sec
#define LS_COMMS_SPEED      100*10              // Number of ticks per event: 15 sec
#define ST_COMMS_SPEED      100*20              // Number of ticks per event: 60 sec
#define MPPT_COMMS_SPEED    100*1               // Number of ticks per event: 1 sec
...
#define LED_TOG        P1OUT ^= LED;
#define LEDY1_ON       P2OUT = LEDY1;
#define LEDY0_ON       P2OUT = LEDY0;
#define LEDG_ON        P2OUT = LEDG;
#define LEDR_ON        P2OUT = LEDR;
#define LEDY1_OFF      P2OUT = ~LEDY1;
#define LEDY0_OFF      P2OUT = ~LEDY0;
#define LEDG_OFF       P2OUT = ~LEDG;
#define LEDR_OFF       P2OUT = ~LEDR;
#define LEDY1_TOG      P2OUT ^= LEDY1;
#define LEDY0_TOG      P2OUT ^= LEDY0;
#define LEDG_TOG       P2OUT ^= LEDG;
#define LEDR_TOG       P2OUT ^= LEDR;
