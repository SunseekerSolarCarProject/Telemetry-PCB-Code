...
uint32_t lookup(uint32_t address, uint32_t *off, int *pos, int *pck, int *row);
...
#define HF_MSG_PACKET 11    //number of messages per packet in high frequency
#define LF_MSG_PACKET  24   //number of messages per packet in low frequency
#define ST_MSG_PACKET  8    //number of messages that we receive and don't send out
...
#define HF_EXPECT_MASK ((HF_MSG_PACKET >= 32) ? 0xFFFFFFFFu : ((1u << HF_MSG_PACKET) - 1u))
#define LF_EXPECT_MASK ((LF_MSG_PACKET >= 32) ? 0xFFFFFFFFu : ((1u << LF_MSG_PACKET) - 1u))
#define ST_EXPECT_MASK ((ST_MSG_PACKET >= 32) ? 0xFFFFFFFFu : ((1u << ST_MSG_PACKET) - 1u))
...
// address,                             OFFSET,  POS(bit),         PKT, PRIO
static uint32_t addr_lookup[LOOKUP_ROWS][5] = {
  // MC1 base/status
  {MC_CAN_BASE1,                         0,      (1u<<0),          2,   18}, // ST: MC1BAS

  // MC1 HF
  {MC_CAN_BASE1 + MC_LIMITS,             0,      (1u<<0),          0,   19}, // HF
  {MC_CAN_BASE1 + MC_BUS,                1,      (1u<<1),          0,    1}, // HF
  {MC_CAN_BASE1 + MC_VELOCITY,           2,      (1u<<2),          0,    2}, // HF

  // MC1 LF
  {MC_CAN_BASE1 + MC_PHASE,              0,      (1u<<0),          1,   20},
  {MC_CAN_BASE1 + MC_V_VECTOR,           1,      (1u<<1),          1,   21},
  {MC_CAN_BASE1 + MC_I_VECTOR,           2,      (1u<<2),          1,   22},
  {MC_CAN_BASE1 + MC_BEMF_VECTOR,        3,      (1u<<3),          1,   23},
  {MC_CAN_BASE1 + MC_RAIL1,              4,      (1u<<4),          1,   24},
  {MC_CAN_BASE1 + MC_RAIL2,              5,      (1u<<5),          1,   25},
  {MC_CAN_BASE1 + MC_TEMP1,              6,      (1u<<6),          1,   26},
  {MC_CAN_BASE1 + MC_TEMP2,              7,      (1u<<7),          1,   27},
  {MC_CAN_BASE1 + MC_CUMULATIVE,         8,      (1u<<8),          1,   28},
  {MC_CAN_BASE1 + MC_SLIPSPEED,          9,      (1u<<9),          1,   29},

  // MC2 base/status
  {MC_CAN_BASE2,                         1,      (1u<<1),          2,   30}, // ST: MC2BAS

  // MC2 HF
  {MC_CAN_BASE2 + MC_LIMITS,             3,      (1u<<3),          0,   31}, // HF
  {MC_CAN_BASE2 + MC_BUS,                4,      (1u<<4),          0,    3}, // HF
  {MC_CAN_BASE2 + MC_VELOCITY,           5,      (1u<<5),          0,    4}, // HF

  // MC2 LF
  {MC_CAN_BASE2 + MC_PHASE,             10,      (1u<<10),         1,   32},
  {MC_CAN_BASE2 + MC_V_VECTOR,          11,      (1u<<11),         1,   33},
  {MC_CAN_BASE2 + MC_I_VECTOR,          12,      (1u<<12),         1,   34},
  {MC_CAN_BASE2 + MC_BEMF_VECTOR,       13,      (1u<<13),         1,   35},
  {MC_CAN_BASE2 + MC_RAIL1,             14,      (1u<<14),         1,   36},
  {MC_CAN_BASE2 + MC_RAIL2,             15,      (1u<<15),         1,   37},
  {MC_CAN_BASE2 + MC_TEMP1,             16,      (1u<<16),         1,   38},
  {MC_CAN_BASE2 + MC_TEMP2,             17,      (1u<<17),         1,   39},
  {MC_CAN_BASE2 + MC_CUMULATIVE,        18,      (1u<<18),         1,   40},
  {MC_CAN_BASE2 + MC_SLIPSPEED,         19,      (1u<<19),         1,   41},

  // DC base/status
  {DC_CAN_BASE,                          2,      (1u<<2),          2,   42}, // ST: DC_BAS

  // DC HF/LF
  {DC_CAN_BASE + DC_DRIVE,               6,      (1u<<6),          0,   10}, // HF
  {DC_CAN_BASE + DC_POWER,              20,      (1u<<20),         1,   13}, // LF
  {DC_CAN_BASE + DC_RESET,               3,      (1u<<3),          2,   14}, // ST
  {DC_CAN_BASE + DC_SWITCH,              7,      (1u<<7),          0,   11}, // HF

  // STW base/status + switch
  {STW_CAN_BASE,                         4,      (1u<<4),          2,   15}, // ST: STWBAS
  {STW_CAN_BASE + STW_SWITCH,            8,      (1u<<8),          0,   16}, // HF

  // BP base/status + shunt/pack + limits
  {BP_CAN_BASE,                          5,      (1u<<5),          2,   17}, // ST: BP_BAS
  {BP_CAN_BASE + BP_VMAX,               21,      (1u<<21),         1,    5}, // LF
  {BP_CAN_BASE + BP_VMIN,               22,      (1u<<22),         1,    6}, // LF
  {BP_CAN_BASE + BP_TMAX,               23,      (1u<<23),         1,    7}, // LF
  {BP_CAN_BASE + BP_PCDONE,              6,      (1u<<6),          2,   12}, // ST
  {BP_CAN_BASE + BP_ISH,                 9,      (1u<<9),          0,    8}, // HF
  {BP_CAN_BASE + BP_PVSS,               10,      (1u<<10),         0,    9}, // HF
  {BP_CAN_BASE + BP_RESET,               7,      (1u<<7),          2,   43}, // ST
};

/*static uint32_t addr_lookup[LOOKUP_ROWS][5] = {
  //address                           ASCII Offset      MSG_REC position        Packet(0-HF:1-LF:2-Status)      Filter Priority
  {MC_CAN_BASE1,                      0,                0x0001,                   3,                            18},                    //0-0x400     High = CAN1_SERIAL Number        Low = "TRIa" string
  {MC_CAN_BASE1 + MC_LIMITS,          0,                0x0100,                   0,                            19},                    //1-0x01        High = Active Motor              Low = Error & Limit flags
  {MC_CAN_BASE1 + MC_BUS,             1,                0x0001,                   0,                             1},                    //2-0x02        High = Bus Current               Low = Bus Voltage
  {MC_CAN_BASE1 + MC_VELOCITY,        2,                0x0002,                   0,                             2},                    //3-0x03        High = Velocity (m/s)            Low = Velocity (rpm)
  {MC_CAN_BASE1 + MC_PHASE,           13,               0x0001,                   0,                            20},                    //4-0x04        High = Phase A Current           Low = Phase B Current
  {MC_CAN_BASE1 + MC_V_VECTOR,        14,               0x0002,                   0,                            21},                    //5-0x05        High = Vd vector                 Low = Vq vector
  {MC_CAN_BASE1 + MC_I_VECTOR,        15,               0x0004,                   0,                            22},                    //6-0x06        High = Id vector                 Low = Iq vector
  {MC_CAN_BASE1 + MC_BEMF_VECTOR,     16,               0x0008,                   3,                            23},                    //7-0x07        High = BEMFd vector              Low = BEMFq vector
  {MC_CAN_BASE1 + MC_RAIL1,           17,               0x0002,                   3,                            24},                    //8-0x08        High = 15V                       Low = Reserved
  {MC_CAN_BASE1 + MC_RAIL2,           18,               0x0004,                   3,                            25},                    //9-0x09        High = 3.3V                      Low = 1.9V
  {MC_CAN_BASE1 + MC_TEMP1,           19,               0x0001,                   3,                            26},                    //10-0x0B       High = Heatsink Temp             Low = Motor Temp
  {MC_CAN_BASE1 + MC_TEMP2,           20,               0x0002,                   3,                            27},                    //11-0x0C       High = Inlet Temp                Low = CPU Temp
  {MC_CAN_BASE1 + MC_CUMULATIVE,      21,               0x0008,                   3,                            28},                    //12-x0E        High = DC Bus AmpHours           Low = Odometer
  {MC_CAN_BASE1 + MC_SLIPSPEED,       22,               0x0010,                   3,                            29},                    //13-0x17       High =Slip Speed (Hz)            Low = Reserved
  {MC_CAN_BASE2,                      0,                0x0001,                   3,                            30},                    //0-0x400     High = CAN1_SERIAL Number        Low = "TRIa" string
  {MC_CAN_BASE2 + MC_LIMITS,          3,                0x0100,                   0,                            31},                    //1-0x01        High = Active Motor              Low = Error & Limit flags
  {MC_CAN_BASE2 + MC_BUS,             4,                0x0004,                   0,                             3},                    //2-0x02        High = Bus Current               Low = Bus Voltage
  {MC_CAN_BASE2 + MC_VELOCITY,        5,                0x0008,                   0,                             4},                    //3-0x03        High = Velocity (m/s)            Low = Velocity (rpm)
  {MC_CAN_BASE2 + MC_PHASE,           23,               0x0001,                   0,                            32},                    //4-0x04        High = Phase A Current           Low = Phase B Current
  {MC_CAN_BASE2 + MC_V_VECTOR,        24,               0x0002,                   0,                            33},                    //5-0x05        High = Vd vector                 Low = Vq vector
  {MC_CAN_BASE2 + MC_I_VECTOR,        25,               0x0004,                   0,                            34},                    //6-0x06        High = Id vector                 Low = Iq vector
  {MC_CAN_BASE2 + MC_BEMF_VECTOR,     26,               0x0008,                   3,                            35},                    //7-0x07        High = BEMFd vector              Low = BEMFq vector
  {MC_CAN_BASE2 + MC_RAIL1,           27,               0x0002,                   3,                            36},                    //8-0x08        High = 15V                       Low = Reserved
  {MC_CAN_BASE2 + MC_RAIL2,           28,               0x0004,                   3,                            37},                    //9-0x09        High = 3.3V                      Low = 1.9V
  {MC_CAN_BASE2 + MC_TEMP1,           29,               0x0001,                   3,                            38},                    //10-0x0B       High = Heatsink Temp             Low = Motor Temp
  {MC_CAN_BASE2 + MC_TEMP2,           30,               0x0002,                   3,                            39},                    //11-0x0C       High = Inlet Temp                Low = CPU Temp
  {MC_CAN_BASE2 + MC_CUMULATIVE,      31,               0x0008,                   3,                            40},                    //12-x0E        High = DC Bus AmpHours           Low = Odometer
  {MC_CAN_BASE2 + MC_SLIPSPEED,       32,               0x0010,                   3,                            41},                    //13-0x17       High =Slip Speed (Hz)            Low = Reserved
  {DC_CAN_BASE,                       0,                0x0800,                   3,                            42},                    //28-0x500    High = CAN1_SERIAL Number        Low = "TRIb" string
  {DC_CAN_BASE + DC_DRIVE,            6,                0x0010,                   0,                            10},                    //29-0x01       High = Motor Current Setpoint    Low = Motor Velocity Setpoint
  {DC_CAN_BASE + DC_POWER,            1,                0x0200,                   3,                            13},                    //30-0x02       High = Bus Current Setpoint      Low = Unused
  {DC_CAN_BASE + DC_RESET,            2,                0x1000,                   3,                            14},                    //31-0x03       High = Unused                    Low = Unused
  {DC_CAN_BASE + DC_SWITCH,           7,                0x0020,                   0,                            11},                    //32-0x04       High = Switch position           Low = Switch state change
  {STW_CAN_BASE,                      0,                0x2000,                   3,                            15},                    //33-0x580    High = BPV2" string or nulls     Low = CAN1_SERIAL Number
  {STW_CAN_BASE + STW_SWITCH,         3,                0x2000,                   3,                            16},                    //33-0x580    High = BPV2" string or nulls     Low = CAN1_SERIAL Number
  {BP_CAN_BASE,                       0,                0x2000,                   3,                            17},                    //33-0x580    High = BPV2" string or nulls     Low = CAN1_SERIAL Number
  {BP_CAN_BASE + BP_VMAX,             8,                0x0040,                   0,                             5},                    //34-0x01       High = Max Voltage               Low = Cell Number
  {BP_CAN_BASE + BP_VMIN,             9,                0x0080,                   0,                             6},                    //35-0x02       High = Min Voltage               Low = Cell Number
  {BP_CAN_BASE + BP_TMAX,             10,               0x0100,                   0,                             7},                    //36-0x03       High = Temp Max                  Low = Cell Number
  {BP_CAN_BASE + BP_PCDONE,           4,                0x0200,                   3,                            12},                    //37-0x04       High = "BPV1" string             Low = CAN1_SERIAL Number
  {BP_CAN_BASE + BP_ISH,              11,               0x0200,                   0,                             8},                    //38-0x05       High = Shunt Current             Low = milliAmps/s
  {BP_CAN_BASE + BP_PVSS,             12,               0x0400,                   0,                             9},                    //38-0x05       High = Shunt Current             Low = Battery Voltage
  {BP_CAN_BASE + BP_RESET,            5,                0x0080,                   3,                            43},                    //38-0x05       High = Shunt Current             Low = Battery Voltage
};*/
