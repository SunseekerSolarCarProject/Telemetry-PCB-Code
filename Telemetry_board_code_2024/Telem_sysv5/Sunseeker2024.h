...
#define No_MSG_PACKET 32    //number of messages that we receive and don't send out
...
static int addr_lookup[LOOKUP_ROWS][5] = {
  ...
  {MC_CAN_BASE1 + MC_LIMITS,          8,                0x0100,                   0,                            19},                    //1-0x01        High = Active Motor              Low = Error & Limit flags
  {MC_CAN_BASE1 + MC_BUS,             0,                0x0001,                   0,                             1},                    //2-0x02        High = Bus Current               Low = Bus Voltage
  {MC_CAN_BASE1 + MC_VELOCITY,        1,                0x0002,                   0,                             2},                    //3-0x03        High = Velocity (m/s)            Low = Velocity (rpm)
  {MC_CAN_BASE1 + MC_PHASE,           1,                0x0001,                   3,                            20},                    //4-0x04        High = Phase A Current           Low = Phase B Current
  {MC_CAN_BASE1 + MC_V_VECTOR,        2,                0x0002,                   3,                            21},                    //5-0x05        High = Vd vector                 Low = Vq vector
  {MC_CAN_BASE1 + MC_I_VECTOR,        3,                0x0004,                   3,                            22},                    //6-0x06        High = Id vector                 Low = Iq vector
  {MC_CAN_BASE1 + MC_BEMF_VECTOR,     4,                0x0008,                   3,                            23},                    //7-0x07        High = BEMFd vector              Low = BEMFq vector
  {MC_CAN_BASE1 + MC_RAIL1,           1,                0x0002,                   3,                            24},                    //8-0x08        High = 15V                       Low = Reserved
  {MC_CAN_BASE1 + MC_RAIL2,           2,                0x0004,                   3,                            25},                    //9-0x09        High = 3.3V                      Low = 1.9V
  {MC_CAN_BASE1 + MC_TEMP1,           0,                0x0001,                   3,                            26},                    //10-0x0B       High = Heatsink Temp             Low = Motor Temp
  {MC_CAN_BASE1 + MC_TEMP2,           1,                0x0002,                   3,                            27},                    //11-0x0C       High = Inlet Temp                Low = CPU Temp
  {MC_CAN_BASE1 + MC_CUMULATIVE,      3,                0x0008,                   3,                            28},                    //12-x0E        High = DC Bus AmpHours           Low = Odometer
  {MC_CAN_BASE1 + MC_SLIPSPEED,       5,                0x0010,                   3,                            29},                    //13-0x17       High =Slip Speed (Hz)            Low = Reserved
  {MC_CAN_BASE2,                      0,                0x0001,                   3,                            30},                    //0-0x400     High = CAN1_SERIAL Number        Low = "TRIa" string
  {MC_CAN_BASE2 + MC_LIMITS,          8,                0x0100,                   3,                            31},                    //1-0x01        High = Active Motor              Low = Error & Limit flags
  {MC_CAN_BASE2 + MC_BUS,             2,                0x0004,                   0,                             3},                    //2-0x02        High = Bus Current               Low = Bus Voltage
  {MC_CAN_BASE2 + MC_VELOCITY,        3,                0x0008,                   0,                             4},                    //3-0x03        High = Velocity (m/s)            Low = Velocity (rpm)
  {MC_CAN_BASE2 + MC_PHASE,           1,                0x0001,                   3,                            32},                    //4-0x04        High = Phase A Current           Low = Phase B Current
  {MC_CAN_BASE2 + MC_V_VECTOR,        2,                0x0002,                   3,                            33},                    //5-0x05        High = Vd vector                 Low = Vq vector
  {MC_CAN_BASE2 + MC_I_VECTOR,        3,                0x0004,                   3,                            34},                    //6-0x06        High = Id vector                 Low = Iq vector
  {MC_CAN_BASE2 + MC_BEMF_VECTOR,     4,                0x0008,                   3,                            35},                    //7-0x07        High = BEMFd vector              Low = BEMFq vector
  {MC_CAN_BASE2 + MC_RAIL1,           1,                0x0002,                   3,                            36},                    //8-0x08        High = 15V                       Low = Reserved
  {MC_CAN_BASE2 + MC_RAIL2,           2,                0x0004,                   3,                            37},                    //9-0x09        High = 3.3V                      Low = 1.9V
  {MC_CAN_BASE2 + MC_TEMP1,           0,                0x0001,                   3,                            38},                    //10-0x0B       High = Heatsink Temp             Low = Motor Temp
  {MC_CAN_BASE2 + MC_TEMP2,           1,                0x0002,                   3,                            39},                    //11-0x0C       High = Inlet Temp                Low = CPU Temp
  {MC_CAN_BASE2 + MC_CUMULATIVE,      3,                0x0008,                   3,                            40},                    //12-x0E        High = DC Bus AmpHours           Low = Odometer
  {MC_CAN_BASE2 + MC_SLIPSPEED,       5,                0x0010,                   3,                            41},                    //13-0x17       High =Slip Speed (Hz)            Low = Reserved
  {DC_CAN_BASE,                      12,                0x0800,                   3,                            42},                    //28-0x500    High = CAN1_SERIAL Number        Low = "TRIb" string
  {DC_CAN_BASE + DC_DRIVE,            4,                0x0010,                   0,                            10},                    //29-0x01       High = Motor Current Setpoint    Low = Motor Velocity Setpoint
  {DC_CAN_BASE + DC_POWER,            9,                0x0200,                   3,                            13},                    //30-0x02       High = Bus Current Setpoint      Low = Unused
  {DC_CAN_BASE + DC_RESET,           13,                0x1000,                   3,                            14},                    //31-0x03       High = Unused                    Low = Unused
  {DC_CAN_BASE + DC_SWITCH,           5,                0x0020,                   0,                            11},                    //32-0x04       High = Switch position           Low = Switch state change
  {STW_CAN_BASE,                     14,                0x2000,                   3,                            15},                    //33-0x580    High = BPV2" string or nulls     Low = CAN1_SERIAL Number
  {STW_CAN_BASE + STW_SWITCH,        14,                0x2000,                   3,                            16},                    //33-0x580    High = BPV2" string or nulls     Low = CAN1_SERIAL Number
  {BP_CAN_BASE,                      14,                0x2000,                   3,                            17},                    //33-0x580    High = BPV2" string or nulls     Low = CAN1_SERIAL Number
  {BP_CAN_BASE + BP_VMAX,             6,                0x0040,                   0,                             5},                    //34-0x01       High = Max Voltage               Low = Cell Number
  {BP_CAN_BASE + BP_VMIN,             7,                0x0080,                   0,                             6},                    //35-0x02       High = Min Voltage               Low = Cell Number
  {BP_CAN_BASE + BP_TMAX,             8,                0x0100,                   0,                             7},                    //36-0x03       High = Temp Max                  Low = Cell Number
  {BP_CAN_BASE + BP_PCDONE,          15,                0x0200,                   3,                            12},                    //37-0x04       High = "BPV1" string             Low = CAN1_SERIAL Number
  {BP_CAN_BASE + BP_ISH,              9,                0x0200,                   0,                             8},                    //38-0x05       High = Shunt Current             Low = milliAmps/s
  {BP_CAN_BASE + BP_PVSS,            10,                0x0400,                   0,                             9},                    //38-0x05       High = Shunt Current             Low = Battery Voltage
  {BP_CAN_BASE + BP_RESET,            7,                0x0080,                   3,                            43},                    //38-0x05       High = Shunt Current             Low = Battery Voltage
};
// removed
